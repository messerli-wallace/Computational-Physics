...
!
      ...
      external DPPTRI
      external DSYEV
      write(1,*) "inverse_home,     inverse_lapack,   diag_home,  diag_lapack"
      do ndim = 2,1000
            ...
            ! call cpu_time(end_t)
            ! print *,'Time =',end_t-start_t,'seconds'
      ...
      !     5 CONTINUE            
            ...
            CALL DSYEV('V','U',ndim,A,ndim,D,work,-1,info)
            call cpu_time(end_4)
            d_lapack = end_4-start_4
            print*, "Time = ",d_lapack," seconds"
            
            write(1,*) inverse_home, inverse_lapack, d_h, d_lapack
      end do
!           
 9002 FORMAT (5F14.7)        
