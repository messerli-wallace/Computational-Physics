...
*        if(i.eq.0.and.j.eq.0) sum = sum + 1.0*h*h
         pot1(i,j) = sum/4.0d0
120    continue
220   continue
*
...
*
      ...
      do 200 i=1,399
       do 210 j=1,399
         error = error+abs(pot0(i,j)-pot1(i,j))
         pot0(i,j) = pot1(i,j)
210    continue
200   continue
*      write(6,4000) niter, error
      write(2,*) niter,error
...
15    continue
      do 310 i=0,400
       do 320 j=0,400
         write(1,4001) h*i,h*j,pot1(i,j)
       write(1,*)
320    continue
310   continue
      do 400 i=0,400
       write(3,4001) h*i,pot1(i,0)
400   continue
*
4000  format('niter = ',i5,'   error = ',1pe14.6)
4001  format(1p10e14.6)
*
      stop
      end
